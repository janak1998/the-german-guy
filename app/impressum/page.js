  ...
  return (
    <div className="flex justify-center items-center h-[600px] px-4 py-10">
        <div className="flex flex-col mb-10 text-xl text-left text-gray-800 dark:text-gray-200 w-fit gap-5">
          ...
          <p>Geschäftsführer: <Button className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded transition-colors max-w-[200px]"><a href="https://www.linkedin.com/in/imawanish5/" target="_blank">Awanish Srivastava</a></Button></p>
          </div>
    </div>
  )
}
